...
public:
	...
	bool begin(	TwoWire &wirePort = Wire, uint8_t address = LPS33HW_I2C_ADDR_DEF, uint32_t clock_frequency = 10000 ); 	// Startup routine that uses the Wire port as the default
